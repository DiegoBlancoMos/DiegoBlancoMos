...
@export var speed: float = 10.0  # Velocidad de movimiento en píxeles por segundo
@export var left_limit: float = -10.0  # Límite izquierdo en la posición X
@export var right_limit: float = 10.0  # Límite derecho en la posición X
